...
@Component({
  selector: 'app-noticia-destacada1',
  templateUrl: './noticia-destacada1.component.html',
  styleUrls: ['./noticia-destacada1.component.scss']
})
export class NoticiaDestacada1Component implements OnInit {
